...
```{r hfe-01, out.width=c('400px', '400px'), fig.cap ='(ref:hfe-01)'}
...
```{r hfe-02, out.width=c('700px', '700px'), fig.cap ='(ref:hfe-02)'}
...
```{r hfe-03, out.width=c('550px', '550px'), fig.cap ='(ref:hfe-03)'}
...
```{r hfe-04, out.width=c('480px', '480px'), fig.cap ='(ref:hfe-04)'}
...
```{r hfe-05, out.width=c('600px', '600px'), fig.cap ='(ref:hfe-05)'}
...
```{r hfe-06, out.width=c('700px', '700px'), fig.cap ='(ref:hfe-06)'}
