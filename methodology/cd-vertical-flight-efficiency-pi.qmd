...
![Different steps of the analysis.](vfe-cd-figure-001.png){#fig-pli-bli}
...
![Rolling window for level segment detection.](vfe-cd-figure-002.png){#fig-vfe-cd-figure-002 height=300px}
...
: Formulas used for the calculation of the results {#tbl-formulas}
