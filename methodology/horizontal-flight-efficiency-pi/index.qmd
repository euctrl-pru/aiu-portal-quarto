...
![HFE as comparison of flight length and Great Circle Distance.](hfe-01.png){#fig-hfe-01 height=250px}
...
![Local Performance Requirement.](hfe-02.png){#fig-hfe-02 height=250px}
...
@fig-hfe-03). This can be calculated as the
difference between
...
![The two Quantities Averaged in the Achieved Distance.](hfe-03.png){#fig-hfe-03 height=300px}


In the @fig-hfe-03, the distance from $N$ to
...
![A case of perfect local efficiency with no network contribution.](hfe-04.png){#fig-hfe-04 height=300px}
...
![Decomposition of Inefficiency.](hfe-05.png){#fig-hfe-05 height=200px}
...
![Independence of local performance from performance outside the local area.](hfe-06.png){#fig-hfe-06 }
...
Consider the situation in @fig-hfe-06 (once again an
...
@tbl-quantities below provides a summary of the different quantities
...
: Summary of the different quantities used to compute HFE {#tbl-quantities}
...
circles are fully inside or outside the reference area, the following
@tbl-locations is valid (the definition of the type of flight is based on the
location of the airports with respect to the reference area):
...
: General location of origin, destination and en-route end-points {#tbl-locations}
