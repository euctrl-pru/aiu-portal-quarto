...
CPRs are positional reports that the [ATC](atc.qmd) surveillance systems transmit to [NM](nm-cfmu.qmd).
They are named "correlated" because the 4D position (longitude, latitude, altitude and timestamp)
is augmented with flight information such as CALLSIGN, [ADEP](adep.qmd),
[ADES](ades.qmd) and ICAO 24-bit address.
...
[FMPs](fmp.qmd) can then evaluate whether the demand in their sectors/areas is above
