...
The Peak Load Index (PLI) and the [Basic Load Index (BLI)](bli.qmd) were defined
...
The [BLI](bli.qmd) measures how much of the available capacity is used across
the majority of the operating conditions.


## See Also

* [Basic Load Index (BLI)](bli.qmd).
